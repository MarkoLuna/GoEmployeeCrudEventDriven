...
func (eSrv EmployeeServiceImpl) CreateEmployee(employeeRequest dto.EmployeeRequest) (*models.Employee, error) {
...
func (eSrv EmployeeServiceImpl) GetEmployees() ([]models.Employee, error) {
	employees, err := eSrv.employeeRepository.FindAll()
	return employees, err
}

func (eSrv EmployeeServiceImpl) GetEmployeeById(employeeId string) (models.Employee, error) {
...
func (eSrv EmployeeServiceImpl) DeleteEmployeeById(employeeId string) error {
