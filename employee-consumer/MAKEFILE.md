# Makefile Documentation — `employee-consumer`

## Variables

| Variable  | Default Value                               | Description                                                 |
|-----------|---------------------------------------------|-------------------------------------------------------------|
| `NAME`    | `employee-consumer`                         | Name of the compiled binary output.                         |
| `PROJECT` | `github.com/MarkoLuna/EmployeeConsumer`     | Go module path. Can be overridden via environment variable. |
...
| Target               | Command(s)                                          | Description                                                                        |
|----------------------|-----------------------------------------------------|------------------------------------------------------------------------------------|
| `docker-build`       | Cross-compile for Linux/amd64 + `docker build`      | Builds a Linux binary and packages it into the `goemployee_consumer:latest` image. |
...
| `k8-remove`| `kubectl delete pod/service ...`                   | Removes the `employeeconsumer-pod` pod and `employeeconsumer-service`.|
