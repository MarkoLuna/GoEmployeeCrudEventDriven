...
- [Running with Kubernetes](#running-with-kubernetes)
  - [1. Booting the Developer Infrastructure (Dependencies)](#1-booting-the-developer-infrastructure-dependencies)
  - [2. Deploying the Microservices Stack](#2-deploying-the-microservices-stack)
    - [Step A: Build the Docker Images](#step-a-build-the-docker-images)
    - [Step B: Apply Configurations, Services, and Ingress](#step-b-apply-configurations-services-and-ingress)
  - [Clean up](#clean-up-everything)
